  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-parchment text-ink">
      <div className="w-full max-w-sm text-center">
        ...
        <p className="text-lg text-leather mb-10">
        ...
        {installed ? (
          ...
          <button
            ...
            className="w-full bg-prussian text-parchment font-accent text-lg uppercase tracking-wide rounded-lg py-4 shadow-lg mb-4"
          >
            Descarrega l&apos;app
          </button>
        )}
