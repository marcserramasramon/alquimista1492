  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-4 pb-8 font-serif">
      ...
      <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden border-2 border-[#8C6D53] shadow-md bg-stone-950">
        <img
          src="/images/scenes/planes-bones.webp"
      ...
      <section className="bg-[#FAF5E9] dark:bg-[#1a130e] border-2 border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-xl p-3.5 sm:p-4 shadow-sm relative overflow-hidden">
        <div className="flex items-center justify-between flex-wrap gap-2 border-b border-[#8C6D53]/30 dark:border-[#8C6D53]/20 pb-2 mb-2.5">
          <div className="flex items-center gap-2">
            <span className="text-2xl">{myWitness.icon}</span>
            <div>
              <span className="text-[10px] uppercase font-mono tracking-wider font-bold bg-[#D8CCAE] dark:bg-[#2c221a] text-[#1D3557] dark:text-[#8bb2e8] px-2 py-0.5 rounded">
                El teu testimoni assignat
              </span>
              <h3 className="font-bold text-[#1D3557] dark:text-[#8bb2e8] text-sm sm:text-base font-serif">
                {myWitness.title}
              </h3>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 text-xs font-sans text-[#5C4533] dark:text-[#c2a68e]">
              ...
              <button
                ...
                className={`w-6 h-6 rounded-full text-xs font-bold transition-all flex items-center justify-center ${
                  state.selectedWitnessId === w.id
                    ...
                    : 'bg-[#E2D6B8] dark:bg-[#2c221a] text-[#5C4533] dark:text-[#c2a68e] hover:bg-[#D8CCAE] dark:hover:bg-[#382b20]'
                }`}
                title={w.title}
              >
                {w.id}
        ...
        <p className="text-xs sm:text-sm text-[#2B2118] dark:text-[#f3ebd8] leading-relaxed italic bg-white/60 dark:bg-[#14100c] p-3 rounded-lg border border-[#8C6D53]/20 dark:border-[#8C6D53]/30 shadow-inner">
          {myWitness.text}
        </p>

        <div className="mt-2 text-[11px] text-[#8C6D53] dark:text-[#c2a68e] font-sans flex items-center justify-between flex-wrap gap-2">
          <span>📍 Informant: <strong>{myWitness.witness}</strong> ({myWitness.location})</span>
          <span className="font-bold text-[#1D3557] dark:text-[#e5a93c]">🗣️ No mostris la pantalla: explica-ho als teus companys!</span>
        </div>
      </section>

      {/* PESTANYES DE NAVEGACIÓ */}
      <div className="bg-[#D8CCAE] dark:bg-[#221a14] border border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-t-xl flex flex-wrap overflow-hidden">
        <button
          type="button"
        ...
        <button
          ...
          className={`flex-1 min-w-[110px] py-2.5 px-3 text-xs sm:text-sm font-bold font-sans transition-all flex items-center justify-center gap-1.5 ${
            state.activeTab === 'troballa'
              ? 'bg-[#EAE0CA] dark:bg-[#14100c] text-[#1D3557] dark:text-[#e5a93c] border-b-2 border-[#1D3557] dark:border-[#e5a93c] shadow-inner'
              : 'text-[#5C4533] dark:text-[#c2a68e] hover:text-[#1D3557] dark:hover:text-[#f3ebd8] hover:bg-[#E2D6B8] dark:hover:bg-[#2c221a]'
          } ${hasReachedCanVinyals && !state.solved ? 'animate-pulse text-amber-900 dark:text-amber-300 font-extrabold' : ''}`}
        >
      ...
      <div className="bg-[#EAE0CA] dark:bg-[#1a130e] border-x border-b border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-b-xl p-3.5 sm:p-5 shadow-sm">
        <AnimatePresence mode="wait">
          ...
          {state.activeTab === 'historia' && (
            ...
            >
              <div className="p-4 bg-[#FAF5E9] dark:bg-[#221a14] border-l-4 border-[#8C6D53] dark:border-[#c99e32] rounded-r-xl shadow-inner space-y-2">
                <span className="text-[10px] uppercase font-mono tracking-wider font-bold text-[#8C6D53] dark:text-[#c2a68e] block">
                  La Declaració d'Isidre el Ferrer
                </span>
                <h3 className="font-bold text-[#1D3557] dark:text-[#8bb2e8] text-base sm:text-lg font-serif">
                  «No vaig participar en cap conspiració: tornava cansat de Malla i vaig perdre la clau»
                </h3>
                <p className="text-[#3A2A1D] dark:text-[#f3ebd8] italic">
              ...
              <div className="p-3.5 bg-[#DFD4BC]/60 dark:bg-[#241a13] border border-[#8C6D53]/40 dark:border-[#8C6D53]/30 rounded-xl space-y-2 font-sans">
                <div className="font-bold text-[#1D3557] dark:text-[#e5a93c] text-sm flex items-center gap-1.5">
                  <span>🎯</span>
                  <span>Com funciona aquesta estació cooperativa:</span>
                </div>
                <ul className="list-disc pl-5 space-y-1.5 text-xs text-[#4A3728] dark:text-[#f3ebd8]">
                  <li>
                    <strong className="text-[#2B2118] dark:text-[#e5a93c]">Informació fragmentada:</strong> Cada membre de l'equip té assignat al seu telèfon el testimoni d'un veí diferent del terme (Malla, la Riera, Can Vinyals, el Pou).
                  </li>
                  <li>
                    <strong className="text-[#2B2118] dark:text-[#e5a93c]">Treball en equip:</strong> No us ensenyeu les pantalles. Expliqueu en veu alta què ha vist el vostre informant.
                  </li>
                  <li>
                    <strong className="text-[#2B2118] dark:text-[#e5a93c]">Reproduir la ruta al mapa:</strong> Aneu a la pestanya <em>Mapa del Camí</em> i connecteu les caselles per on va passar Isidre seguint les declaracions.
                  </li>
                  <li>
                    <strong className="text-[#2B2118] dark:text-[#e5a93c]">Cerca física al carrer:</strong> Un cop deduït on va caure la clau, aneu físicament a la <em>Pedra Gran de Can Vinyals</em> i escanegeu el codi QR (o introduïu el codi <code className="bg-amber-100 dark:bg-[#14100c] text-amber-900 dark:text-[#e5a93c] px-1 py-0.5 rounded border border-amber-300 dark:border-[#8C6D53]/40 font-mono">CLAU-FORJA</code>).
                  </li>
                </ul>
              </div>
              ...
              <div className="flex justify-center pt-1">
                <button
                  type="button"
                  onClick={() => setState((prev) => ({ ...prev, activeTab: 'mapa' }))}
                  className="py-3 px-6 bg-[#1D3557] hover:bg-[#152740] dark:bg-[#c99e32] dark:hover:bg-[#e5a93c] text-white dark:text-[#14100c] font-sans font-bold text-sm rounded-lg shadow-md transition flex items-center gap-2 cursor-pointer"
                >
          ...
          {state.activeTab === 'mapa' && (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#8C6D53]/40 dark:border-[#8C6D53]/30 pb-2">
                <div>
                  <h3 className="font-bold text-[#1D3557] dark:text-[#8bb2e8] text-sm sm:text-base font-serif">
                    Plànol Cartogràfic de Planes Bones (1705)
                  </h3>
                  <p className="text-[11px] sm:text-xs text-[#5C4533] dark:text-[#c2a68e] font-sans">
                ...
                <div className="flex items-center gap-1.5 self-start sm:self-auto">
                  <button
                    ...
                    className="py-1 px-2.5 bg-[#FAF5E9] dark:bg-[#2c221a] hover:bg-white dark:hover:bg-[#382b20] text-stone-700 dark:text-[#f3ebd8] disabled:opacity-40 border border-[#8C6D53]/40 dark:border-[#8C6D53]/30 rounded text-xs font-sans font-bold flex items-center gap-1 transition"
                  >
                  ...
                  <button
                    ...
                    onClick={handleReset}
                    disabled={state.pathProgress.length <= 1 || state.solved}
                    className="py-1 px-2.5 bg-[#FAF5E9] dark:bg-[#2c221a] hover:bg-white dark:hover:bg-[#382b20] text-stone-700 dark:text-[#f3ebd8] disabled:opacity-40 border border-[#8C6D53]/40 dark:border-[#8C6D53]/30 rounded text-xs font-sans font-bold transition"
                  >
                    Reiniciar
                  </button>
                </div>
              ...
              <div className="w-full overflow-x-auto flex justify-center bg-[#F4EDE0] dark:bg-[#1f1711] p-2 sm:p-4 rounded-xl border-2 border-[#B59A72] dark:border-[#8C6D53]/50 shadow-inner relative">
                <div className="absolute inset-0 bg-gradient-to-b from-[#FDFBF5] via-[#F8F2E6] to-[#EFE3CF] dark:from-[#2a1e15] dark:via-[#1e150e] dark:to-[#17100a] opacity-95 pointer-events-none rounded-xl" />
              ...
              <div className="flex flex-wrap items-center justify-between text-[11px] text-[#5C4533] dark:text-[#f3ebd8] font-sans bg-[#F8F3E6] dark:bg-[#221a14] p-2.5 rounded-lg border border-[#B59A72]/50 dark:border-[#8C6D53]/40 gap-2">
                ...
                <div
                  className={`p-3 rounded-lg border text-xs sm:text-sm font-sans flex items-start gap-2 ${
                    state.lastFeedback.type === 'error'
                      ? 'bg-red-50 dark:bg-[#2c1515] border-red-300 dark:border-red-700/60 text-red-900 dark:text-red-200'
                      : state.lastFeedback.type === 'success'
                      ? 'bg-emerald-50 dark:bg-[#102a1c] border-emerald-400 dark:border-emerald-600/60 text-emerald-900 dark:text-emerald-200'
                      : 'bg-[#F4EBD9] dark:bg-[#221a14] border-[#8C6D53]/40 dark:border-[#8C6D53]/30 text-[#4A3728] dark:text-[#f3ebd8]'
                  }`}
                >
                  ...
                  <div className="flex-1 font-medium">{state.lastFeedback.message}</div>
                </div>
              )}

              {/* ALERTA DE LOCALITZACIÓ DE LA PEDRA GRAN */}
              {hasReachedCanVinyals && !state.solved && (
                <div className="p-3.5 bg-amber-50 dark:bg-[#24170c] border-2 border-amber-500 dark:border-amber-500/80 rounded-xl shadow-md flex flex-col sm:flex-row items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <span className="text-3xl">🪨</span>
                    <div>
                      <h4 className="font-serif font-bold text-sm text-amber-950 dark:text-[#E5A93C]">
                        Objectiu localitzat: Pedra Gran de Can Vinyals!
                      </h4>
                      <p className="text-xs text-amber-900 dark:text-[#F3EBD8] font-sans mt-0.5">
                  ...
                  <button
                    type="button"
                    onClick={() => setState((prev) => ({ ...prev, activeTab: 'troballa' }))}
                    className="py-2.5 px-4 bg-amber-600 hover:bg-amber-700 dark:bg-[#C99E32] dark:hover:bg-[#E5A93C] text-white dark:text-[#14100C] font-sans font-bold text-xs rounded-lg shadow transition flex items-center gap-1.5 whitespace-nowrap cursor-pointer"
                  >
          ...
          {state.activeTab === 'interrogatori' && (
            <motion.div
              ...
              className="space-y-3.5"
            >
              <div className="border-b border-[#8C6D53]/40 dark:border-[#8C6D53]/30 pb-2">
                <h3 className="font-bold text-[#1D3557] dark:text-[#8bb2e8] text-sm sm:text-base font-serif">
                  ...
                  <div
                    ...
                    className={`p-3.5 rounded-xl border transition-all ${
                      state.selectedWitnessId === witness.id
                        ? 'bg-[#FAF5E9] dark:bg-[#281e16] border-[#1D3557] dark:border-[#e5a93c] shadow ring-2 ring-[#C99E32]'
                        : 'bg-[#F4EBD9] dark:bg-[#1e1711] border-[#8C6D53]/30 dark:border-[#8C6D53]/25'
                    }`}
                  >
                    <div className="flex items-center justify-between gap-1 mb-1.5">
                      <span className="text-lg">{witness.icon}</span>
                      <span className="text-[10px] font-mono font-bold uppercase bg-[#D8CCAE] dark:bg-[#2c221a] text-[#1D3557] dark:text-[#8bb2e8] px-2 py-0.5 rounded">
                        {witness.location}
                      </span>
                    </div>

                    <h4 className="font-serif font-bold text-sm text-[#2B2118] dark:text-[#f3ebd8]">
                      {witness.title}
                    </h4>
                    <p className="text-[11px] text-[#8C6D53] dark:text-[#c2a68e] font-sans mt-0.5">
                      Informant: <strong>{witness.witness}</strong>
                    </p>

                    <p className="text-xs text-[#4A3728] dark:text-[#f3ebd8] mt-2 font-serif italic bg-white/70 dark:bg-[#14100c] p-2.5 rounded border border-[#8C6D53]/20 dark:border-[#8C6D53]/30">
                      {witness.text}
                    </p>
                  </div>
                ))}
            ...
            >
              {!state.solved ? (
                <div className="space-y-4">
                  <div className="p-4 bg-[#FAF5E9] dark:bg-[#1f1711] border-2 border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-xl shadow-sm">
                    <h3 className="font-bold text-[#1D3557] dark:text-[#8bb2e8] text-base font-serif flex items-center gap-2 mb-1">
                      <span>🪨</span>
                      <span>La Pedra Gran de Can Vinyals</span>
                    </h3>
                    <p className="text-xs sm:text-sm text-[#4A3728] dark:text-[#f3ebd8] leading-relaxed font-sans">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                      <button
                        ...
                        className="flex-1 py-3 px-4 bg-[#1D3557] hover:bg-[#152740] dark:bg-[#c99e32] dark:hover:bg-[#e5a93c] text-white dark:text-[#14100c] font-sans font-bold text-sm rounded-lg shadow-md transition flex items-center justify-center gap-2 cursor-pointer"
                      >
                  ...
                  <div className="p-4 bg-[#FAF5E9] dark:bg-[#1f1711] border border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-xl">
                    <h4 className="font-serif font-bold text-sm text-[#2B2118] dark:text-[#f3ebd8] mb-1">
                      O bé introdueix el codi de seguretat manual:
                    </h4>
                    <p className="text-xs text-[#5C4533] dark:text-[#c2a68e] font-sans mb-3">
                    ...
                    >
                      <input
                        ...
                        className="flex-1 p-3 border-2 border-[#8C6D53] dark:border-[#8C6D53]/60 rounded-lg bg-white dark:bg-[#14100c] text-[#1D3557] dark:text-[#e5a93c] font-mono font-bold text-base tracking-wider focus:outline-none focus:ring-2 focus:ring-[#C99E32] shadow-inner uppercase"
                      />

                      <button
                        type="submit"
                        disabled={!state.manualCode.trim()}
                        className="py-3 px-6 bg-[#C99E32] hover:bg-amber-500 dark:bg-[#c99e32] dark:hover:bg-[#e5a93c] disabled:opacity-50 text-[#121E2B] font-bold font-sans rounded-lg shadow transition flex items-center justify-center gap-2 cursor-pointer"
                      >
                  ...
                  {state.lastFeedback && state.lastFeedback.type === 'error' && (
                    <div className="p-2.5 bg-red-50 dark:bg-[#2c1515] border border-red-300 dark:border-red-700/60 text-red-900 dark:text-red-200 rounded text-xs font-sans flex items-center gap-2">
                      <span>⚠️</span>
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <div className="p-4 bg-emerald-50 dark:bg-emerald-950/40 border-2 border-emerald-600 dark:border-emerald-500 rounded-xl text-emerald-950 dark:text-emerald-100 shadow-inner">
                    ...
                    <p className="text-xs sm:text-sm font-sans text-emerald-800 dark:text-emerald-200 leading-relaxed">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="p-3.5 bg-[#FAF5E9] dark:bg-[#1a130e] border border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-lg shadow-sm">
                      ...
                      <p className="text-xs text-[#5C4533] dark:text-[#f3ebd8] mt-1 font-sans">
                  ...
                  <div className="p-4 bg-[#1D3557] dark:bg-[#1a2332] text-[#FAF5E9] rounded-xl border-2 border-[#C99E32] shadow text-center">
                    <div className="text-[11px] font-mono uppercase tracking-widest text-[#C99E32] font-bold">
                      XIFRA DE L'ELEMENT DESCOBERTA
                    </div>
                    <div className="text-2xl sm:text-3xl font-bold font-serif mt-1 flex items-center justify-center gap-2.5">
                      <img src="/images/elements/terra.webp" alt="Terra" className="w-9 h-9 object-contain drop-shadow" />
                      <span>TERRA = 3</span>
                    </div>
      ...
      {showScannerModal && (
        <div className="fixed inset-0 z-50 bg-black/80 flex flex-col items-center justify-center p-4">
          <div className="bg-[#FAF5E9] dark:bg-[#1a130e] border-2 border-[#8C6D53] dark:border-[#8C6D53]/40 rounded-xl w-full max-w-md overflow-hidden shadow-2xl">
            <div className="bg-[#1D3557] dark:bg-[#221a14] text-white dark:text-[#e5a93c] p-3 flex items-center justify-between border-b dark:border-[#8C6D53]/40">
              <span className="font-serif font-bold text-sm">Escaneja el QR de la Pedra</span>
              <button
                type="button"
                onClick={() => setShowScannerModal(false)}
                className="w-7 h-7 flex items-center justify-center rounded bg-white/20 hover:bg-white/30 text-white font-bold cursor-pointer"
              >
                ✕
              </button>
            </div>
            ...
            <div className="p-4 space-y-3">
              <div className="relative w-full aspect-square rounded-lg overflow-hidden border border-[#8C6D53] dark:border-[#8C6D53]/40 bg-black">
                <Scanner
                  onScan={handleQRScan}
                  onError={(err) => {
              ...
              {scannerError ? (
                <div className="p-2 bg-amber-50 dark:bg-[#24170c] border border-amber-300 dark:border-amber-700/60 text-amber-900 dark:text-[#f3ebd8] rounded text-xs font-sans">
                  ⚠️ {scannerError}
                </div>
              ) : (
                <p className="text-xs text-center text-[#5C4533] dark:text-[#c2a68e] font-sans">
              ...
              <button
                type="button"
                onClick={() => setShowScannerModal(false)}
                className="w-full py-2.5 bg-[#D8CCAE] hover:bg-[#C99E32] dark:bg-[#c99e32] dark:hover:bg-[#e5a93c] text-[#2B2118] dark:text-[#14100c] font-bold text-xs rounded transition font-sans cursor-pointer"
              >
